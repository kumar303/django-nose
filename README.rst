...
If you need to make a couple plugins specifically for your Django app, you can put your plugin class somewhere within your app and load them from settings.py like this::
